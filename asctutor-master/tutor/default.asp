    ...
    <div class="container">
      ...
      <!-- Main hero unit for a primary marketing message or call to action -->
        ...
        if TimeChanges = 0 then
            Response.write("<div class='alert alert-error'> Please edit your availability by clicking <a href='edit-availability.asp'>here</a> or edit your availability.")
            Response.write("<br/> This warning will remain until you do so. </div>")
        else
         ...
         %>
        	...
        	<div class= "well">
	            ...
	            <p class="lead">
		        	...
		        	<a href="drop-or-add-tutees.asp">View your tutee times.</a><br />
