...
<%		
		...
		connn.Mode = 3
		connn.Open "Provider=sqloledb;SERVER=localhost;DATABASE=asc_tutor;UID=ASC;PWD=B3sm3rASC" 'original server:testsql.win.winthrop.edu  database:asc_tutor uid=asc_tutor_access pwd=TeachMeStuff
		...
		set RS1 = Server.CreateObject("ADODB.RECORDSET")
		    RS1.Open "SELECT * FROM Course", con0, 0, 1
