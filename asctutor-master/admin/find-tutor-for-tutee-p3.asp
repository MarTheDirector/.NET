        ...
        do until rstutorcourses.EOF
           ...
           if rstutorcourses2.eof <> true then
            ...
            do until rstutorcourses2.eof
		        ...
		        if pass then
		                Response.Write("<label class='radio'><input type='radio' name='date' onchange='showinfo(this.value)' value="&ID&","&TuteeCourse&","&TuteeUserName&">"&DisplayThisTime&"</label>" & vbCrLf)
		        end if
